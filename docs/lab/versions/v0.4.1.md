...
- Release on 13.07.2026
- GitHub release <https://github.com/climet-eu/lab/releases/tag/v0.4.1>
...
- Update `numcodecs-wasm`
- Update the `numcodecs-wasm-*` family of packages, see <https://numcodecs-wasm.readthedocs.io>, now also including `-onion` and `-pressio`
- Upgrade `aiohttp`, `idna`, `msgpack`, `soupsieve`, `ujson`, and `WebOb`, which all released security bug fixes
...
numcodecs_wasm == 0.2.5
numcodecs_wasm_asinh == 0.4.0
numcodecs_wasm_bit_round == 0.5.0
numcodecs_wasm_ebcc == 0.3.1a0
...
numcodecs_wasm_onion == 0.1.0
numcodecs_wasm_pco == 0.4.0
numcodecs_wasm_pressio == 0.1.0b2
